...
public class FishingGameDemo extends JPanel implements ActionListener, KeyListener {
    ...
    public FishingGameDemo() {
        setPreferredSize(new Dimension(panelWidth, panelHeight));
        setFocusable(true);
        addKeyListener(this);

        sharkImg = new ImageIcon("images/shark.jpg").getImage();
        hookImg = new ImageIcon("images/hook.jpg").getImage();
    ...
    public static void main(String[] args) {
        ...
        FishingGameDemo game = new FishingGameDemo();
